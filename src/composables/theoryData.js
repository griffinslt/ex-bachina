    ...
    [
        {
            ...
            content: ["Welcome to the walkthough.",
                ...
                "It may also be worth to glance at the flow diagram to get an overview of the whole process. This demostrates the decision making process, especially make note of the selection nodes and the loops in the diagram.",
        ...
        },
        {
            ...
            content: [
                ...
                "Auxillary notes can be added when the next note is the same as the current note. They are a step below the note and they go between the two identical notes."
            ]
        },
        {
            ...
            content: [
                ...
                "Again, do not forget to add the passing and auxillary notes for intrigure."
